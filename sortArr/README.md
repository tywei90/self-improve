Update：此项目已经抽离出来，做成两个npm包：[arr-sort](https://github.com/tywei90/arr-sort), [arr-del](https://github.com/tywei90/arr-del)。功能增强，支持nested对象属性并支持传入比较函数功能。此文件夹下项目已不再维护。
